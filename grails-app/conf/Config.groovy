...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'app.auth.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'app.auth.UserRole'
